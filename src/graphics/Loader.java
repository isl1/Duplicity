...
public class Loader {
	...
	private TextureData decodeTextureFile(String fileName) {
		...
		try {
			...
			e.printStackTrace();
			System.err.println("Skybox texture " + fileName + " failed to load");
			System.exit(-1);
		}
	...
	private void bindIndicesBuffer(int[] indices){
		...
		GL15.glBufferData(GL15.GL_ELEMENT_ARRAY_BUFFER, buffer, GL15.GL_DYNAMIC_DRAW); //change to static if static model
	}
